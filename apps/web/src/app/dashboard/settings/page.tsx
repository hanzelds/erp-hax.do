...
const VARS: Record<string, { name: string; example: string }[]> = {
  ...
  QUOTE: [
    { name: '{{quote.number}}',          example: 'COT-H-00001' },
    { name: '{{quote.status}}',          example: 'BORRADOR' },
    { name: '{{date quote.createdAt}}',  example: '19 de abril de 2026' },
    { name: '{{date quote.validUntil}}', example: '19 de mayo de 2026' },
    { name: '{{fmt quote.subtotal}}',    example: 'RD$ 10,000.00' },
    { name: '{{fmt quote.taxAmount}}',   example: 'RD$ 1,800.00' },
    { name: '{{fmt quote.total}}',       example: 'RD$ 11,800.00' },
    { name: '{{quote.notes}}',           example: 'Notas de la cotización' },
    { name: '{{quote.terms}}',           example: 'Términos y condiciones' },
    { name: '{{client.name}}',           example: 'Empresa Ejemplo SRL' },
    { name: '{{client.rnc}}',            example: '1-31-12345-6' },
    { name: '{{client.email}}',          example: 'info@empresa.com' },
    { name: '{{company.name}}',          example: 'HAX ESTUDIO CREATIVO EIRL' },
